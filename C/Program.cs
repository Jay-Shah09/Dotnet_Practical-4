...
namespace Code_3
{
    class Program
    {
        ...
        {
            Employee e1 = new Employee("John","smilga",45000);
            Employee e2 = new Employee("Peter","Parker",53000);
            ...
            PermanentEmployee pe1 = new PermanentEmployee("John","smilga",45000,5000,1000,4500,"01-02-2022","10-05-2022");

            PermanentEmployee pe2 = new PermanentEmployee("Peter","Parker",53000,7000,500,9500,"01-01-2022","18-12-2022");
